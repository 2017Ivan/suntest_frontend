...
<div class="sticky top-0 z-20 bg-white border-b border-gray-200 shadow-sm">
  <div class="max-w-7xl mx-auto px-2 sm:px-4 py-2 sm:py-3">
    <div class="flex items-center justify-between sm:justify-center relative">
      ...
      <button 
        @click="goBack"
        class="p-1.5 sm:p-2 hover:bg-gray-100 rounded-full transition-colors duration-200 flex-shrink-0"
      >
      ...
      <!-- Empty div to maintain space-between on small screens -->
          ...
          <div>
            ...
            <div class="grid grid-cols-3 gap-3">
              <div 
                ...
                :class="{ 'border-2 border-rose-500 bg-rose-50': isSelectedInBetSlip('1') }"
              >
              ...
              <div 
                ...
                class="cursor-pointer bg-gray-50 border border-gray-200 rounded-lg p-3 text-center hover:shadow-md transition-all"
                :class="{ 'border-2 border-rose-500 bg-rose-50': isSelectedInBetSlip('X') }"
              >
              ...
              <div 
                ...
                class="cursor-pointer bg-gray-50 border border-gray-200 rounded-lg p-3 text-center hover:shadow-md transition-all"
                :class="{ 'border-2 border-rose-500 bg-rose-50': isSelectedInBetSlip('2') }"
              >
