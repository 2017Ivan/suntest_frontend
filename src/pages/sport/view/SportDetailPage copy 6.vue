        ...
        <div class="space-y-6">
          ...
          <div>
            ...
            <div class="grid grid-cols-3 gap-3">
              <div 
                @click="handleOddsClick('1', matchData.homeOdds, 'Home Win', '1X2 | Full Time')"
              ...
              <div 
                @click="handleOddsClick('X', matchData.drawOdds, 'Draw', '1X2 | Full Time')"
                class="cursor-pointer bg-gray-50 border border-gray-200 rounded-lg p-3 text-center hover:shadow-md transition-all"
              ...
              <div 
                @click="handleOddsClick('2', matchData.awayOdds, 'Away Win', '1X2 | Full Time')"
                class="cursor-pointer bg-gray-50 border border-gray-200 rounded-lg p-3 text-center hover:shadow-md transition-all"
          ...
          <div>
            ...
            <div class="grid grid-cols-3 gap-3">
              <div 
                v-for="(odd, key) in doubleChanceOdds"
                :key="key"
                @click="handleOddsClick(key, odd, key, 'Double Chance | Full Time')"
                class="cursor-pointer bg-gray-50 border border-gray-200 rounded-lg p-3 text-center hover:shadow-md transition-all"
