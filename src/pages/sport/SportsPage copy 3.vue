<template>
  <div class="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 pb-10">
    ...
    <div class="max-w-7xl mx-auto px-4 mt-6">
      ...
      >
        <!-- League Header -->
        <div class="sticky top-12 z-10 py-2 pl-1 bg-gradient-to-b from-gray-200 via-gray-100/0 to-gray-200 backdrop-blur-sm">
      ...
      <!-- View All Button -->
      <div class="text-center py-1.5 bg-gradient-to-b from-gray-200 via-gray-100/0 to-gray-200 backdrop-blur-sm rounded-xl mt-2">
