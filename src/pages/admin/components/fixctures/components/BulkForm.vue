<template>
  <div>
    <div class="mb-4">
      <label class="text-rose-400 text-xs sm:text-sm block mb-1.5">Number of matches to add</label>
      <div class="flex flex-wrap gap-2 sm:gap-3">
        <input 
          ...
          min="1"
          max="20"
          class="w-20 sm:w-32 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg bg-slate-900 border border-rose-800 text-rose-100 text-sm"
        />
        <button 
          @click="addMatches"
