<template>
  <div class="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 pb-10">
    ...
    <div class="relative overflow-hidden">
      ...
      <div class="relative max--w-full mx-auto px-2 flex flex-col flex-wrap items-center gap-5">
       ...
       <!-- Balance Card -->
        <div class="flex flex-col max-w-7xl py-3 shadow-[0_0_32px_rgba(244,63,94,0.05)]">
          

          <p class="text-sm font-bold text-gray-400 uppercase tracking-widest mb-1">Account balance</p>
          ...
          <div class="flex items-center justify-between gap-3">
            <RouterLink to="/deposite"
              class="flex-1 flex items-center justify-center gap-1.5 py-2 px-2 rounded-xl text-xs font-bold border border-rose-400/30 text-rose-400 hover:bg-rose-400/8 transition-opacity">
            ...
            <RouterLink to="/withdraw"
              class="flex-1 flex items-center justify-center gap-1.5 py-2 px-2 rounded-xl text-xs font-bold border border-rose-400/30 text-rose-400 hover:bg-rose-400/8 transition-colors">
          ...
          <div class="flex items-center justify-center py-2 gap-3">
           <p class="text-sm font-bold text-gray-400 uppercase tracking-widest">+{{ user.phone_number }}</p>
          </div>
        </div>
