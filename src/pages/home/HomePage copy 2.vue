<template>
  <div class="max-w-7xl mx-auto bg-black">
    ...
    >
      ...
      <div class="sticky top-0 z-10 py-2 px-3 bg-gray-500/30 ">
        <div class="flex items-center justify-between">
          <span class="text-sm font-bold text-white truncate">{{ leagueName }}</span>
         

           <div class="flex gap-1 flex-shrink-0">
              <span 
                class="w-12 sm:w-14 text-center text-xs sm:text-sm font-bold text-gray-100  hover:text-white rounded transition-colors duration-200"
              >
                1
              </span>
              <span 
    ...
    <!-- View All Button -->
    <div class="text-center mt-4 py-3 bg-gray-100 rounded-lg">
      <button class="text-rose-500 hover:text-rose-600 font-semibold text-sm transition-colors">
        View All Sports →
      </button>
    </div>
