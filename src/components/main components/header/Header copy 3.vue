<template>
  <header class="bg-rose-700 shadow-lg sticky top-0 z-50">
      ...
      <div class="flex items-center justify-between max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 h-14 sm:h-16 bg-gradient-to-r from-rose-900 to-rose-950 border-b border-rose-800">
        <!-- Logo/Brand -->
        ...
        <div class="flex items-center gap-1 sm:gap-2">
          ...
          <div class="flex-1 relative min-w-0">
            <input 
              ...
              class="w-full px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base bg-white text-white placeholder-rose-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-rose-400/20 transition-all duration-200"
