  ...
  <header class=" bg-rose-700 shadow-lg sticky top-0 z-50 ">
      ...
      <div class="flex items-center justify-between  mx-auto px-2  h-14 bg-gradient-to-r from-rose-900 to-rose-950 border-b border-rose-800 ">
       <div class="flex items-center gap-1">
          ...
          <button
            class="lg:hidden flex items-center justify-center rounded-[10px] bg-transaparent text-gray-400 hover:text-white transition-colors"
      ...
      >
        ...
        <!-- Search Suggestions -->  <!-- <svg class="w-4 h-4 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg> -->
